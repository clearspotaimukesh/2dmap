...
class Orthomosaic:
    ...
    def mixer(self):
        ...
        while image_queue:
            ...
            self.temp_image = self.sticher(self.temp_image, next_image)
    ...
    def sticher(self, image1, image2):
        # Try using SIFT for feature detection and matching
        sift = cv2.SIFT_create()  # You can also try cv2.AKAZE_create()
